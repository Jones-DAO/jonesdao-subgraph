...
export class SsovV3OptionsToken extends ethereum.SmartContract {
  static bind(address: Address): SsovV3OptionsToken {
    return new SsovV3OptionsToken("SsovV3OptionsToken", address);
  }
  ...
  try_collateralSymbol(): ethereum.CallResult<string> {
    let result = super.tryCall(
      "collateralSymbol",
      "collateralSymbol():(string)",
      []
  ...
  optionValue(): BigInt {
    let result = super.call("optionValue", "optionValue():(uint256)", []);

    return result[0].toBigInt();
  }

  try_optionValue(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("optionValue", "optionValue():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class Initialize1Call__Inputs {
  ...
  get _collateralSymbol(): string {
    return this._call.inputValues[5].value.toString();
  }

  get _expirySymbol(): string {

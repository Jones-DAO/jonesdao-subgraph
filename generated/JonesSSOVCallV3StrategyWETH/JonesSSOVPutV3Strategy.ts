...
export class JonesSSOVPutV3Strategy extends ethereum.SmartContract {
  static bind(address: Address): JonesSSOVPutV3Strategy {
    return new JonesSSOVPutV3Strategy("JonesSSOVPutV3Strategy", address);
  }
  ...
  sell2CrvForBase(
    ...
    _minStableAmount: BigInt,
    _minAssetAmount: BigInt
  ): BigInt {
    let result = super.call(
      "sell2CrvForBase",
      "sell2CrvForBase(uint256,address,uint256,uint256):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(_amount),
        ethereum.Value.fromAddress(_stableToken),
        ethereum.Value.fromUnsignedBigInt(_minStableAmount),
        ethereum.Value.fromUnsignedBigInt(_minAssetAmount)
      ]
    );
  ...
  sellBaseFor2Crv(
    ...
    _stableToken: Address,
    _minStableAmount: BigInt,
    _min2CrvAmount: BigInt
  ): BigInt {
    let result = super.call(
      "sellBaseFor2Crv",
      "sellBaseFor2Crv(uint256,address,uint256,uint256):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(_baseAmount),
        ethereum.Value.fromAddress(_stableToken),
        ethereum.Value.fromUnsignedBigInt(_minStableAmount),
        ethereum.Value.fromUnsignedBigInt(_min2CrvAmount)
      ]
    );
...
export class Sell2CrvForBaseCall extends ethereum.Call {
  get inputs(): Sell2CrvForBaseCall__Inputs {
    return new Sell2CrvForBaseCall__Inputs(this);
  }

  get outputs(): Sell2CrvForBaseCall__Outputs {
    return new Sell2CrvForBaseCall__Outputs(this);
  }
}

export class Sell2CrvForBaseCall__Inputs {
  _call: Sell2CrvForBaseCall;

  constructor(call: Sell2CrvForBaseCall) {
    this._call = call;
  }
  ...
  get _minStableAmount(): BigInt {
    return this._call.inputValues[2].value.toBigInt();
  }

  get _minAssetAmount(): BigInt {
    return this._call.inputValues[3].value.toBigInt();
  }
}

export class Sell2CrvForBaseCall__Outputs {
  _call: Sell2CrvForBaseCall;
...
export class SellBaseFor2CrvCall extends ethereum.Call {
  get inputs(): SellBaseFor2CrvCall__Inputs {
    return new SellBaseFor2CrvCall__Inputs(this);
  }

  get outputs(): SellBaseFor2CrvCall__Outputs {
    return new SellBaseFor2CrvCall__Outputs(this);
  }
}

export class SellBaseFor2CrvCall__Inputs {
  _call: SellBaseFor2CrvCall;

  constructor(call: SellBaseFor2CrvCall) {
    this._call = call;
  }
  ...
  get _min2CrvAmount(): BigInt {
    return this._call.inputValues[3].value.toBigInt();
  }
}

export class SellBaseFor2CrvCall__Outputs {
  _call: SellBaseFor2CrvCall;
...
export class SellUSDCForAssetCall extends ethereum.Call {
  get inputs(): SellUSDCForAssetCall__Inputs {
    return new SellUSDCForAssetCall__Inputs(this);
  }

  get outputs(): SellUSDCForAssetCall__Outputs {
    return new SellUSDCForAssetCall__Outputs(this);
  }
}

export class SellUSDCForAssetCall__Inputs {
  _call: SellUSDCForAssetCall;

  constructor(call: SellUSDCForAssetCall) {
    this._call = call;
  }

  get _minAssetOutputFromUSDCSwap(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }
}

export class SellUSDCForAssetCall__Outputs {
  _call: SellUSDCForAssetCall;
...
export class Swap2CRVBalanceForUSDCCall extends ethereum.Call {
  get inputs(): Swap2CRVBalanceForUSDCCall__Inputs {
    return new Swap2CRVBalanceForUSDCCall__Inputs(this);
  }

  get outputs(): Swap2CRVBalanceForUSDCCall__Outputs {
    return new Swap2CRVBalanceForUSDCCall__Outputs(this);
  }
}

export class Swap2CRVBalanceForUSDCCall__Inputs {
  _call: Swap2CRVBalanceForUSDCCall;

  constructor(call: Swap2CRVBalanceForUSDCCall) {
    this._call = call;
  }

  get _minUSDCOutput(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }
}

export class Swap2CRVBalanceForUSDCCall__Outputs {
  _call: Swap2CRVBalanceForUSDCCall;

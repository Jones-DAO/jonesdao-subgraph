...
export class GohmSSOVV2__getEpochTimesResult {
  value0: BigInt;
  value1: BigInt;
...
export class GohmSSOVV2__purchaseResult {
  value0: BigInt;
  value1: BigInt;
...
export class GohmSSOVV2 extends ethereum.SmartContract {
  static bind(address: Address): GohmSSOVV2 {
    return new GohmSSOVV2("GohmSSOVV2", address);
  }
  ...
  getEpochTimes(epoch: BigInt): GohmSSOVV2__getEpochTimesResult {
    let result = super.call(
      "getEpochTimes",
    ...
    return new GohmSSOVV2__getEpochTimesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getEpochTimes(
    epoch: BigInt
  ): ethereum.CallResult<GohmSSOVV2__getEpochTimesResult> {
    let result = super.tryCall(
      "getEpochTimes",
      "getEpochTimes(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(epoch)]
    ...
    return ethereum.CallResult.fromValue(
      new GohmSSOVV2__getEpochTimesResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  purchase(
    ...
    return new GohmSSOVV2__purchaseResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_purchase(
    ...
    amount: BigInt,
    user: Address
  ): ethereum.CallResult<GohmSSOVV2__purchaseResult> {
    let result = super.tryCall(
      "purchase",
      "purchase(uint256,uint256,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GohmSSOVV2__purchaseResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }

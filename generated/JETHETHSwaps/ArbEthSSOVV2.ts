...
export class ArbEthSSOVV2__getEpochTimesResult {
  value0: BigInt;
  value1: BigInt;
...
export class ArbEthSSOVV2 extends ethereum.SmartContract {
  static bind(address: Address): ArbEthSSOVV2 {
    return new ArbEthSSOVV2("ArbEthSSOVV2", address);
  }
  ...
  getEpochTimes(epoch: BigInt): ArbEthSSOVV2__getEpochTimesResult {
    let result = super.call(
      "getEpochTimes",
    ...
    return new ArbEthSSOVV2__getEpochTimesResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getEpochTimes(
    epoch: BigInt
  ): ethereum.CallResult<ArbEthSSOVV2__getEpochTimesResult> {
    let result = super.tryCall(
      "getEpochTimes",
      "getEpochTimes(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(epoch)]
    ...
    return ethereum.CallResult.fromValue(
      new ArbEthSSOVV2__getEpochTimesResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  totalEpochStrikeEthBalance(param0: BigInt, param1: BigInt): BigInt {
    let result = super.call(
      "totalEpochStrikeEthBalance",
      "totalEpochStrikeEthBalance(uint256,uint256):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(param0),
        ethereum.Value.fromUnsignedBigInt(param1)
      ]
  ...
  try_totalEpochStrikeEthBalance(
    param0: BigInt,
    param1: BigInt
  ): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
  ...
  withdraw(withdrawEpoch: BigInt, strikeIndex: BigInt): Array<BigInt> {
    let result = super.call(
      "withdraw",
      "withdraw(uint256,uint256):(uint256[3])",
      [
...
export class ConstructorCall__Inputs {
  ...
  get _chainlinkAggregator(): Address {

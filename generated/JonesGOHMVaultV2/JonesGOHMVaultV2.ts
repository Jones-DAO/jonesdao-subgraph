...
export class JonesGOHMVaultV2 extends ethereum.SmartContract {
  static bind(address: Address): JonesGOHMVaultV2 {
    return new JonesGOHMVaultV2("JonesGOHMVaultV2", address);
  }

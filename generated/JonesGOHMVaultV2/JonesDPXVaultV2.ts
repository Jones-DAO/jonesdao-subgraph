...
export class JonesDPXVaultV2 extends ethereum.SmartContract {
  static bind(address: Address): JonesDPXVaultV2 {
    return new JonesDPXVaultV2("JonesDPXVaultV2", address);
  }

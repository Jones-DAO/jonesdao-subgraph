...
export class GMXVault__getDeltaResult {
  value0: boolean;
  value1: BigInt;
...
export class GMXVault__getGlobalShortDeltaResult {
  value0: boolean;
  value1: BigInt;
...
export class GMXVault__getPositionResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class GMXVault__getPositionDeltaResult {
  value0: boolean;
  value1: BigInt;
...
export class GMXVault__positionsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class GMXVault__validateLiquidationResult {
  value0: BigInt;
  value1: BigInt;
...
export class GMXVault extends ethereum.SmartContract {
  static bind(address: Address): GMXVault {
    return new GMXVault("GMXVault", address);
  }
  ...
  getDelta(
    ...
    return new GMXVault__getDeltaResult(
      result[0].toBoolean(),
      result[1].toBigInt()
    );
  }
  ...
  try_getDelta(
    ...
    _isLong: boolean,
    _lastIncreasedTime: BigInt
  ): ethereum.CallResult<GMXVault__getDeltaResult> {
    let result = super.tryCall(
      "getDelta",
      "getDelta(address,uint256,uint256,bool,uint256):(bool,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new GMXVault__getDeltaResult(value[0].toBoolean(), value[1].toBigInt())
    );
  }
  ...
  getGlobalShortDelta(_token: Address): GMXVault__getGlobalShortDeltaResult {
    let result = super.call(
      "getGlobalShortDelta",
    ...
    return new GMXVault__getGlobalShortDeltaResult(
      result[0].toBoolean(),
      result[1].toBigInt()
    );
  }
  ...
  try_getGlobalShortDelta(
    _token: Address
  ): ethereum.CallResult<GMXVault__getGlobalShortDeltaResult> {
    let result = super.tryCall(
      "getGlobalShortDelta",
      "getGlobalShortDelta(address):(bool,uint256)",
      [ethereum.Value.fromAddress(_token)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GMXVault__getGlobalShortDeltaResult(
        value[0].toBoolean(),
        value[1].toBigInt()
      )
    );
  ...
  getPosition(
    ...
    return new GMXVault__getPositionResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getPosition(
    ...
    _indexToken: Address,
    _isLong: boolean
  ): ethereum.CallResult<GMXVault__getPositionResult> {
    let result = super.tryCall(
      "getPosition",
      "getPosition(address,address,address,bool):(uint256,uint256,uint256,uint256,uint256,uint256,bool,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GMXVault__getPositionResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getPositionDelta(
    ...
    _indexToken: Address,
    _isLong: boolean
  ): GMXVault__getPositionDeltaResult {
    let result = super.call(
      "getPositionDelta",
    ...
    return new GMXVault__getPositionDeltaResult(
      result[0].toBoolean(),
      result[1].toBigInt()
    );
  }
  ...
  try_getPositionDelta(
    ...
    _indexToken: Address,
    _isLong: boolean
  ): ethereum.CallResult<GMXVault__getPositionDeltaResult> {
    let result = super.tryCall(
      "getPositionDelta",
      "getPositionDelta(address,address,address,bool):(bool,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GMXVault__getPositionDeltaResult(
        value[0].toBoolean(),
        value[1].toBigInt()
      )
    );
  ...
  positions(param0: Bytes): GMXVault__positionsResult {
    let result = super.call(
      "positions",
    ...
    return new GMXVault__positionsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_positions(param0: Bytes): ethereum.CallResult<GMXVault__positionsResult> {
    let result = super.tryCall(
      "positions",
      "positions(bytes32):(uint256,uint256,uint256,uint256,uint256,int256,uint256)",
      [ethereum.Value.fromFixedBytes(param0)]
  ...
  validateLiquidation(
    ...
    _isLong: boolean,
    _raise: boolean
  ): GMXVault__validateLiquidationResult {
    let result = super.call(
      "validateLiquidation",
    ...
    return new GMXVault__validateLiquidationResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_validateLiquidation(
    ...
    _isLong: boolean,
    _raise: boolean
  ): ethereum.CallResult<GMXVault__validateLiquidationResult> {
    let result = super.tryCall(
      "validateLiquidation",
      "validateLiquidation(address,address,address,bool,bool):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new GMXVault__validateLiquidationResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
